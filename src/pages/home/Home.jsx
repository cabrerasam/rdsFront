        ...
        <section className='w-4/6'>
          <article className='w-full relative'>
            ...
            <figure className='overflow-hidden rounded-2xl'>
              <img className='h-90 w-full object-cover hover:scale-102 transition-all duration-500' src='https://erbol.com.bo/sites/default/files/fiscalia-eeuu.jpg' alt='' />
            </figure>
            ...
            <p className='text-gray-400 line-clamp-2'>Representantes de la Fiscalía de Bolivia participaron de una reunión de alto nivel con una delegación de la Oficina de Asuntos Internacionales de Narcóticos y Cumplimiento de la Ley (INL) de Estados Unidos, con la fiscalidad de dialogar sobre la cooperación bilateral en esta área estratégica.</p>
          </article>
        </section>
        <aside className='w-2/6 border border-gray-800 rounded-2xl p-4 flex flex-col justify-center'>
          ...
          <ul className='mt-4 flex flex-col gap-5'>
            <li className='flex items-center gap-2 border-b border-gray-800 pb-4'>
              ...
              <img src='https://erbol.com.bo/sites/default/files/fiscalia-eeuu.jpg' alt='' className='h-[100px] w-[100px] object-cover hover:scale-102 transition-all duration-500' />
            </li>
            <li className='flex items-center gap-2 border-b border-gray-800 pb-4'>
              <p className='text-light text-sm flex flex-col'>Fiscalía y delegación de EEUU hablan para fortalecer el combate al narcotráfico<span className='text-[12px] text-gray-400 mt-2'>12/ene/2025</span></p>
              <img src='https://erbol.com.bo/sites/default/files/fiscalia-eeuu.jpg' alt='' className='h-[100px] w-[100px] object-cover hover:scale-102 transition-all duration-500' />
